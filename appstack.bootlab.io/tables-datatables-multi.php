...
<head>
	...
	<title>DataTables Multi Selection | Medi Lab - Admin </title>

	<link rel="canonical" href="tables-datatables-multi.php" />
...
<div class="wrapper">
		<nav id="sidebar" class="sidebar">
			<div class="sidebar-content js-simplebar" style="background: #ca5151;">
				<a class="sidebar-brand" href="index.ph[">
						...
						<div class="col-12">
							<div class="card">
								<div class="card-header">
									...
									<h6 class="card-subtitle text-muted">This example shows the multi option. Note how a click on a row will toggle its selected state without effecting other rows, unlike the os and single options
										shown in other examples. See official documentation <a href="https://datatables.net/extensions/select/examples/initialisation/multi.php" target="_blank"
